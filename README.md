...
This is a macro I created that a data analyst at a school district uses to go from raw data pulled from PowerSchool to data that can be quickly uploaded back to PowerSchool (a student information system).  The macro takes the courses that a student took and increments them specifically to what the requirements are for a concentrator or a completer within each program of study.  Once the student has been incremented there are checks after each incrementation that will display information based on when they became a concetrator or a completer.   

Update: 5.6.24 - Customer wants to include an additional field (CIP Code).  Received the corresponding codes and will implement a change within the concentrator and completer checks below.
...
Public Sub increments()
    ...
    Dim cips As Worksheet: Set cips = ThisWorkbook.Worksheets("Cip_Codes")
        ...
        If main.Cells(i, 1) = main.Cells(i + 1, 1) Then
            ...
            If acc_con = 2 Or _
               ...
               prog_soft_dev_con = 2 Then
                    ...
                    'Cip Codes concentrator
                    If acc_con = 2 Then
                        
                        If IsEmpty(pso.Cells(DestRow, 4)) Then
                            pso.Cells(DestRow, 4) = cips.Cells(3, 2)
                        ElseIf Not IsEmpty(pso.Cells(DestRow, 4)) Then
                            pso.Cells(DestRow, 10) = cips.Cells(3, 2)
                        End If
                        
                    ElseIf pl_an_sys_con = 50 Then
                        
                        If IsEmpty(pso.Cells(DestRow, 4)) Then
                            pso.Cells(DestRow, 4) = cips.Cells(82, 2)
                        ElseIf Not IsEmpty(pso.Cells(DestRow, 4)) Then
                            pso.Cells(DestRow, 10) = cips.Cells(82, 2)
                        End If
                    
                    ElseIf auto_tech_con = 2 Then
                        
                        If IsEmpty(pso.Cells(DestRow, 4)) Then
                            pso.Cells(DestRow, 4) = cips.Cells(11, 2)
                        ElseIf Not IsEmpty(pso.Cells(DestRow, 4)) Then
                            pso.Cells(DestRow, 10) = cips.Cells(11, 2)
                        End If
                    
                    ElseIf cul_art_con = 2 Then
                       
                        If IsEmpty(pso.Cells(DestRow, 4)) Then
                            pso.Cells(DestRow, 4) = cips.Cells(29, 2)
                        ElseIf Not IsEmpty(pso.Cells(DestRow, 4)) Then
                            pso.Cells(DestRow, 10) = cips.Cells(29, 2)
                        End If
                    
                    ElseIf dig_art_des_con = 2 Then
                        
                        If IsEmpty(pso.Cells(DestRow, 4)) Then
                            pso.Cells(DestRow, 4) = cips.Cells(31, 2)
                        ElseIf Not IsEmpty(pso.Cells(DestRow, 4)) Then
                            pso.Cells(DestRow, 10) = cips.Cells(31, 2)
                        End If
                       
                    ElseIf ece_con = 2 Then
                        
                        If IsEmpty(pso.Cells(DestRow, 4)) Then
                            pso.Cells(DestRow, 4) = cips.Cells(32, 2)
                        ElseIf Not IsEmpty(pso.Cells(DestRow, 4)) Then
                            pso.Cells(DestRow, 10) = cips.Cells(32, 2)
                        End If
                    
                    ElseIf envi_nat_res_con = 2 Then
                        
                        If IsEmpty(pso.Cells(DestRow, 4)) Then
                            pso.Cells(DestRow, 4) = cips.Cells(40, 2)
                        ElseIf Not IsEmpty(pso.Cells(DestRow, 4)) Then
                            pso.Cells(DestRow, 10) = cips.Cells(40, 2)
                        End If
                       
                    ElseIf gen_manag_con = 2 Then
                    
                        If IsEmpty(pso.Cells(DestRow, 4)) Then
                            pso.Cells(DestRow, 4) = cips.Cells(47, 2)
                        ElseIf Not IsEmpty(pso.Cells(DestRow, 4)) Then
                            pso.Cells(DestRow, 10) = cips.Cells(47, 2)
                        End If
                     
                    ElseIf graph_comm_con = 2 Then
                    
                        If IsEmpty(pso.Cells(DestRow, 4)) Then
                            pso.Cells(DestRow, 4) = cips.Cells(50, 2)
                        ElseIf Not IsEmpty(pso.Cells(DestRow, 4)) Then
                            pso.Cells(DestRow, 10) = cips.Cells(50, 2)
                        End If
                       
                    ElseIf health_sci_con = 2 Then
                    
                        If IsEmpty(pso.Cells(DestRow, 4)) Then
                            pso.Cells(DestRow, 4) = cips.Cells(51, 2)
                        ElseIf Not IsEmpty(pso.Cells(DestRow, 4)) Then
                            pso.Cells(DestRow, 10) = cips.Cells(51, 2)
                        End If
                    
                    ElseIf horti_con = 1 Then
                    
                        If IsEmpty(pso.Cells(DestRow, 4)) Then
                            pso.Cells(DestRow, 4) = cips.Cells(54, 2)
                        ElseIf Not IsEmpty(pso.Cells(DestRow, 4)) Then
                            pso.Cells(DestRow, 10) = cips.Cells(54, 2)
                        End If
                        
                    ElseIf mark_manag_con = 2 Then
                    
                        If IsEmpty(pso.Cells(DestRow, 4)) Then
                            pso.Cells(DestRow, 4) = cips.Cells(71, 2)
                        ElseIf Not IsEmpty(pso.Cells(DestRow, 4)) Then
                            pso.Cells(DestRow, 10) = cips.Cells(71, 2)
                        End If
                    
                    ElseIf media_tech_con = 2 Then
                    
                        If IsEmpty(pso.Cells(DestRow, 4)) Then
                            pso.Cells(DestRow, 4) = cips.Cells(74, 2)
                        ElseIf Not IsEmpty(pso.Cells(DestRow, 4)) Then
                            pso.Cells(DestRow, 10) = cips.Cells(74, 2)
                        End If
                    
                    ElseIf pltw_biomed_sci_con = 2 Then
                    
                        If IsEmpty(pso.Cells(DestRow, 4)) Then
                            pso.Cells(DestRow, 4) = cips.Cells(16, 2)
                        ElseIf Not IsEmpty(pso.Cells(DestRow, 4)) Then
                            pso.Cells(DestRow, 10) = cips.Cells(16, 2)
                        End If
                       
                    ElseIf pltw_pre_eng_con = 2 Or _
                           pltw_pre_eng_con = 3 Then
                    
                        If IsEmpty(pso.Cells(DestRow, 4)) Then
                            pso.Cells(DestRow, 4) = cips.Cells(86, 2)
                        ElseIf Not IsEmpty(pso.Cells(DestRow, 4)) Then
                            pso.Cells(DestRow, 10) = cips.Cells(86, 2)
                        End If
                        
                    ElseIf sports_med_con = 2 Then
                    
                        If IsEmpty(pso.Cells(DestRow, 4)) Then
                            pso.Cells(DestRow, 4) = cips.Cells(93, 2)
                        ElseIf Not IsEmpty(pso.Cells(DestRow, 4)) Then
                            pso.Cells(DestRow, 10) = cips.Cells(93, 2)
                        End If
                    
                    ElseIf fam_con_sci_con = 2 Then
                    
                        If IsEmpty(pso.Cells(DestRow, 4)) Then
                            pso.Cells(DestRow, 4) = cips.Cells(42, 2)
                        ElseIf Not IsEmpty(pso.Cells(DestRow, 4)) Then
                            pso.Cells(DestRow, 10) = cips.Cells(42, 2)
                        End If
                    
                    ElseIf prog_soft_dev_con = 2 Then
                    
                        If IsEmpty(pso.Cells(DestRow, 4)) Then
                            pso.Cells(DestRow, 4) = cips.Cells(87, 2)
                        ElseIf Not IsEmpty(pso.Cells(DestRow, 4)) Then
                            pso.Cells(DestRow, 10) = cips.Cells(87, 2)
                        End If
            ...
            ElseIf (acc_comp >= 21 And acc_comp <= 25) Or _
                   ...
                   (prog_soft_dev_comp >= 21 And prog_soft_dev_comp <= 25) Then
                        ...
                        ElseIf (graph_comm_comp >= 21 And graph_comm_comp <= 23) Then
                        ...
                        ElseIf (health_sci_comp >= 21 And health_sci_comp <= 28) Then
